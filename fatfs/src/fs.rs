...
unsafe impl Sync for FsOptions {}
unsafe impl Send for FsOptions {}
impl FsOptions {
...
unsafe impl<T: ReadWriteSeek> Sync for FileSystem<T> {}
unsafe impl<T: ReadWriteSeek> Send for FileSystem<T> {}
